package net.hexnowloading.hexfortress.entity.ai;
...
public class GroundPathNavigationWide extends GroundPathNavigation {
    ...
    protected void followThePath() {
        ...
        //double d0 = Math.abs(this.mob.getX() - ((double)vector3i.getX() + (this.mob.getBbWidth() + 1) / 2D));
        //double d1 = Math.abs(this.mob.getY() - (double)vector3i.getY());
        //double d2 = Math.abs(this.mob.getZ() - ((double)vector3i.getZ() + (this.mob.getBbWidth() + 1) / 2D));
