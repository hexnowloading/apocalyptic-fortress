...
import net.hexnowloading.hexfortress.block.property.EmblemState;
...
public class HFProperties {
    ...
    public static final EnumProperty<EmblemState> EMBLEM_STATE = EnumProperty.create("emblem_state", EmblemState.class);
