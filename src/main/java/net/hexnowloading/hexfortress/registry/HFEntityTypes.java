...
public class HFEntityTypes {
    ...
    public static final RegistryObject<EntityType<WildfireEntity>> WILDFIRE = ENTITY_TYPES.register("wildfire", () -> EntityType.Builder.of(WildfireEntity::new, MobCategory.MONSTER).sized(0.8F, 2.8F).build(new ResourceLocation(HexFortress.MODID, "wildfire").toString()));
    public static final RegistryObject<EntityType<FortressWalkerEntity>> FORTRESS_WALKER = ENTITY_TYPES.register("fortress_walker", () -> EntityType.Builder.of(FortressWalkerEntity::new, MobCategory.MONSTER).sized(5.0F, 4.0F).build(new ResourceLocation(HexFortress.MODID, "fortress_walker").toString()));
